...
class TransactionType extends BaseModel {
    ...
    const TYPE_LOSE_COMMISSION         = 27;
    const TYPE_CANCEL_LOSE_COMMISSION  = 28;
    const TYPE_PAY_SALARY              = 29;
    const TYPE_GET_SALARY              = 30;
    ...
    public static $transactionTypesAvailble = [
        self::TYPE_DEPOSIT,
        self::TYPE_WITHDRAW,
        self::TYPE_BET,
        self::TYPE_DROP,
        self::TYPE_SEND_PRIZE,
        self::TYPE_CANCEL_PRIZE,
    ];
...
//        $this->withdrawable = $oFundFlow->withdrawable;
    ...
    public static function getTransactionTypesByParams($aParams = [], $aColumns = null) {
        $aColumns or $aColumns = ['id', 'description', 'cn_title'];
        $oRecords = self::complexWhere($aParams)->get($aColumns);
        return $oRecords;
    }
    ...
    public static function getAllTransactionTypesArray() {
        ...
        if ($bReadDb) {
            $aAllTypes         = [];
            $aTransactionTypes = static::getAllTransactionTypes();
