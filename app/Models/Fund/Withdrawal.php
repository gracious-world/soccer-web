...
//    const WITHDRAWAL_STATUS_TRANSACTION_FINISHED = 11; // 汇款成功，即已提交汇款凭证
...
//                $aExtraData['status'] = $iToStatus;
        return $bSucc = static::where('id', '=', $this->id)->whereIn('status', static::$manualCanChangeStatus)->update(['status' => self::WITHDRAWAL_STATUS_FAIL]);
    }
