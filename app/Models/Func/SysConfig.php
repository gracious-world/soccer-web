...
//        'formated_default_value' => 'between:1,1024',
    ...
    /**
     * 读取配置值，需要对返回值进行严格检查
     * @param StringTool $sItem
     * @return StringTool or bool    未设置时返回默认值，配置项不存在时返回false
     */
...
//        die($sDataSource);
    ...
    /**
     * 读取竞彩禁止投注时间以及原因描述 data_source(时间)  description(游戏禁止投注原因)
      */
    public static function getDataSourceInfo($sItem) {
        return static::where('item', '=', $sItem)->get(['data_source'])->first();
    }
