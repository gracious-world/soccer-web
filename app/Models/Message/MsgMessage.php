...
class MsgMessage extends BaseModel {
    ...
    {
        return $this->belongsToMany('App\Models\User\User', 'msg_users', 'msg_id', 'receiver_id')->withTimestamps();
    }

    public function admin_users()
    {
        return $this->belongsToMany('App\Models\Admin\AdminUser', 'msg_users', 'msg_id', 'sender_id')->withTimestamps();
    }
    ...
    protected function beforeValidate() {
        ...
        // exit;
        $this->sender_id or $this->sender_id = Session::get('admin_user_id');
        $this->sender    or $this->sender = Session::get('admin_username');
