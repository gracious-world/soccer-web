...
class PaymentLEYING extends BasePlatform {
    ...
    public function & compileInputData($oPaymentPlatform, $oPaymentAccount, $oDeposit, $oBank, & $sSafeStr) {
        $data       = $aInputData = [
            ...
            'orderDetails' => $oDeposit->order_no . ',' . $oDeposit->amount * 100 . ',,' . '充值'  . ',' . 1,
            ...
            'remark' => 'leying-test',     // todo: 生成remark
            'charset' => 1,
            'signType' => 2,
        ];
    ...
    public function & compileQueryData($oPaymentAccount, $sOrderNo, $sServiceOrderNo) {
        $data  = [
            ...
            'endTime'       => '',
            'partnerID'     => $oPaymentAccount->account,
            'remark'        => 'leying_query',     // todo: 生成remark
            'charset'       => 1,
            'signType'      => 2,
        ];
...
//        file_put_contents('/tmp/xs', var_export($aResponse,true));
