...
class RoleUser extends BaseModel {
    ...
    public static function checkUserRoleRelation($role_id, $user_id) {
        ...
        $oRoleUser = static::where('role_id', '=', $role_id)->where('user_id', '=', $user_id)->first();
    ...
    public static function getUserIdsFromRoleId($iRoleId) {
        $data = [];
        $oUserIds = static::where('role_id', '=', $iRoleId)->get(['user_id']);
    ...
    public static function getUserRoleFromUserIdRoleId($iRoleId, $iUserId) {
        $oRoleUser = static::where('role_id', '=', $iRoleId)->where('user_id', '=', $iUserId)->first();
        return $oRoleUser;
    }
