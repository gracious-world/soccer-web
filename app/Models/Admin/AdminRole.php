...
class AdminRole extends BaseModel {
    ...
    public function users(){
        return $this->belongsToMany('App\Models\Admin\AdminUser', 'admin_role_admin_user', 'role_id', 'user_id')->withPivot(AdminRoleUser::$columnsForPivot)->withTimestamps();
    }
...
//    {
//        $data = [];
//        $aRoles = static::where('role_type', '=', $iRoleType)->get(['id', 'name']);
...
//        exit;
    ...
    public function & explodeRights(){
        if ($this->id == self::ADMIN){
            $aRights = Functionality::whereIn('realm',[Functionality::REALM_SYSTEM, Functionality::REALM_ADMIN])->lists('id')->toArray();
        }
        else{
