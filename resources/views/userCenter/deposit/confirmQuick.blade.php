            ...
            <table width="100%" class="table-field" id="J-table">
                ...
                @if ($oPlatform->need_bank)
                    <tr>
                        ...
                        <td>
                            <label class="img-bank" for="J-bank-name-{!! $oBank->bank_identifier !!}" style="cursor:default;">
                            <!--<input name="bank[]" id="J-bank-name-{!! $oBank->bank_identifier !!}" type="radio" style="visibility:hidden;" />-->
                                <span class="ico-bank {!! $oBank->bank_identifier !!}">{!!$oBank->bank_name!!}</span>
                            </label>
                            <br />
                        </td>
                    </tr>
