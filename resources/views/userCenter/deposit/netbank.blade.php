...
<div class="content recharge-netbank">
    <div class="recharge-box">
        ...
        <form action="{!! route('bank-deposits.netbank',$iPlatformId) !!}" method="post" id="J-form">
            ...
            <table width="100%" class="table-field">
                ...
                @if($oPlatform->payer_name_enabled)
                <tr>
                    <td align="right" valign="top">付款人：</td>
                    <td><input name="payer_name" class="btn" type="text" value="" /><span style="color:#ff0000;margin-left:20px">请填写支付宝的真实姓名</span>
                </tr>
                @endif
                @if($oPlatform->identifier == 'ZFB')
                <tr>
                    <td>&nbsp;</td>
                    <td>支付宝充值最快30分钟，最慢2小时到帐</td>
...
(function($){
    ...
    buildingView = function(bankData){
        ...
        $('#J-money-max').text(gagame.util.formatMoney(Number(bankData['max'])));
        // $('#J-input-money').val('');
    ...
    $('#J-submit').click(function(){
        ...
        @if($oPlatform->payer_name_enabled)
        var payerName = $('input[name="payer_name"]').val();
