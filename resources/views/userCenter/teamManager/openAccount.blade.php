    ...
    <div class="box-register box-register-border">
        <form action="{{route("users.accurate-create")}}" method="post" id="signupForm">
            ...
            <div class="clearfix oneLine">
                ...
                <div class="f-3"><input type="text" name="SelfID" class="input"></div>
            ...
            <div class="clearfix oneLine">
                ...
                <div class="f-3"><input type="text" name="wx" class="input"></div>
            </div>
            <div class="clearfix ">
                <div class="f-2 label"></div>
                <div class="f-3"><input type="submit" class="btn w-2" value="生成账户"/></div>
            </div>
        </form>
    </div>
</div>
