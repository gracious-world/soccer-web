...
<div class="search-report">
    ...
    <ul>
        ...
        <li>
            ...
            <label>佣金总额</label><dfn>￥</dfn><span data-money-format>{!!number_format($oAgentSumInfo['total_commission'],2) !!}</span>
        <li>
            <label>中奖总额</label><dfn>￥</dfn><span data-money-format>{!! number_format($oAgentSumInfo['total_prize'],2) !!}</span><br>
            <label>输值佣金</label><dfn>￥</dfn><span data-money-format>{!! number_format($oAgentSumInfo['total_lose_commission'],2) !!}</span><br>
        </li>
        <li>
            <label>促销奖金</label><dfn>￥</dfn><span data-money-format>{!! number_format($oAgentSumInfo['total_bonus'],2) !!}</span><br>
