...
<div class="content recharge-confirm recharge-netbank">
    ...
    <form action="{!! route('user-withdrawal.require-withdrawal', 1) !!}" method="post" id="J-form">
...
(function($){
    ...
    var ipt1 = $('#J-input-money'),
        ...
        bankSelect = new gagame.Select({realDom:'#J-select-bank',cls:'w-5'});
    ...
    bankSelect.addEvent('change', function(e, value, text){
        ...
        //                 $('#J-money-min').text(gagame.util.formatMoney(data['data']['min']));
        //                 $('#J-money-max').text(gagame.util.formatMoney(data['data']['max']));
        //             }else{
        //                 alert(data['msg']);
        //             }
        //         },
