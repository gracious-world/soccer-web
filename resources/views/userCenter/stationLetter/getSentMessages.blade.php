...
<div class="nav-bg nav-bg-tab">
    ...
    <ul class="tab-title clearfix">
        <li><a href="{!! route('station-letters.index') !!}"><span>收信箱</span></a></li>
        <li class="current"><a href="{!! route('station-letters.outbox') !!}"><span>发信箱</span></a></li>
        <li><a href="javascript:void(0);" class="btn btn-important" id="J-sendBox">发送信息</a></li>
        ...
        <tbody>
            @foreach ($datas as $data)
                ...
                <tr>
                    ...
                    <td>{!! ($aParent['id'] == $data->receiver_id) ? '直属上级' : $data->receiver !!}</td>
