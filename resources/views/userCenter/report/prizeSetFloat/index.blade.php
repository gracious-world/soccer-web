...
<script>
    (function ($) {
        $('#J-date-start-from').focus(function () {
            (new gagame.DatePicker({input: '#J-date-start-from', isShowTime: false, startYear: 2013})).show();
        });
        $('#J-date-start-to').focus(function () {
            (new gagame.DatePicker({input: '#J-date-start-to', isShowTime: false, startYear: 2013})).show();
        });
