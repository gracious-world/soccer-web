  ...
  <div id="reg-content" class="wrap">
        <div class="wrap-inner clearfix">
            <div class="slogan-text">
                <h2>安捷竞彩平台出品，必属精品</h2>
                <p>安捷竞彩平台竞彩投注志在打造亚洲最佳精品游戏平台，为您创造安全、稳定、便捷的游戏世界。无限财富等您赢取！</p>
            </div>
            <div class="reg-wrap">
                    ...
                    <form action="{!! $sKeyword ? route('signup', ['prize' => $sKeyword]) : route('signup') !!}" method="post" id="signupForm">
                        ...
                        <ul class="form-ul">
                            ...
                            <!-- <li class="name-li space-li" data-action="account">
                                ...
                                <span class="feild-static-tip">真实姓名不能为空,请填写真实姓名</span>
                            </li> -->
                            ...
                            <li class="password-li" data-action="account">
                                <label> * 登录密码</label>
                                <div class="input-group">
                                    <input type="password" name="password" tabindex="4" id="J-password" class="input" value="">
                            ...
                            <li class="repassword-li" data-action="account">
                                <label> * 确认密码</label>
                                <div class="input-group">
                                    <input type="password" tabindex="5" class="input" id="J-password2" name="password_confirmation" />
                                    <span class="ico-right"></span>
                            ...
                            <li class="vcode-li space-li" data-action="vcode">
                                <label> * 验证码</label>
                                <div class="input-group">
                                    <input type="text" tabindex="10" id="J-vcode" name="captcha" class="input" />
                                    <span class="ico-right"></span>
                            ...
                            <li class="button-li">
                                <label>&nbsp;</label>
                                <button type="submit" tabindex="11" id="J-button-submit">提交注册信息</button>
                            </li>
                        </ul>
...
(function($) {
    ...
    //     if( !v ){
    //         tip.html('真实姓名不能为空，请输入真实姓名').show();
    //         right.hide();
    //         return;
    //     };
    //     tip.hide();
    ...
    $('#J-button-submit').click(function() {
        ...
        // if(name.val() == ''){
        //      name.siblings('.ui-text-prompt').show().end()
