...
//     else
//         return '<a href="javascript:void(0)"'.app('html')->attributes($attributes).'>'.$name.'</a>';
// }
...
function generateSerialNumber($sPre = '') {
    $sStartYear    = 2016;
    $aYearCodes    = array('A','B','C','D','E','F','G','H','I','J');
    $sSerialNumber = $aYearCodes[intval(date('Y')) - $sStartYear].
